...
public class AutoBrandsSpinnerAdapter extends BaseAdapter
{
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent)
    {
        ...
        TextView tvOfficialSite = (TextView) view.findViewById(R.id.tvOfficialSite);
        tvOfficialSite.setText(autoBrand.getOfficialSite());
    ...
    {
        View view = layoutInflater.inflate(R.layout.selected_item, parent, false);
